            ...
            <div class="svg-wrapper">
              <svg height="300" width="300" xmlns="http://www.w3.org/2000/svg" id="graph" @click="validateFromGraph">
                ...
                <path id="circle"
                      ...
                      fill-opacity="0.2"
                      stroke="blue"
                      d="M 200 150 A 50 50, 90, 0, 1, 150 200 L 150 150 Z"></path>
                ...
                <polygon id="rectangle"
                         ...
                         fill-opacity="0.2"
                         stroke="blue"
                         points="250,50 250,150 150,150 150,50"></polygon>
                ...
                <polygon id="triangle"
                         ...
                         fill-opacity="0.2"
                         stroke="blue"
                         points="150,150 50,150 150,250"></polygon>
  ...
  watch: {
    ...
    r(val){
      if(this.validateInput(-3, 5, 'input-r', val)) {
        ...
        circle.setAttribute("d", `M ${150 + 10 * r} 150 A ${r * 10} ${r * 10}, 90, 0, 1, 150 ${150 + 10 * r} L 150 150 Z`);
        rectangle.setAttribute("points", `${150 + 20 * r},${150 - 20 * r} ${150 + 20 * r},150 150,150 150,${150 - 20 * r}`);
        triangle.setAttribute("points", `150,150 ${150 - 20 * r},150 150,${150 + 20 * r}`);
        this.drawDots();}
